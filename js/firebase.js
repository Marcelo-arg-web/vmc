...
// Configuración por defecto (para que el sistema funcione sin pasar por Configuración)
...
export function initFirebase(){
  ...
  if(!cfg) throw new Error("No se pudo cargar la configuración de Firebase.");
